...
test.exe: Test.o reconocedor_automata.o 
	gcc Test.o reconocedor_automata.o  -o test.exe
...
clean:
	rm -f main.o reconocedor_automata.o main.exe Test.o test.exe salida.txt
